...
def Create_noise_terrain(): # ノイズ
    ...
    #cmds.deformer( type='basicPerlinDeformer')
    cmds.textureDeformer(vectorStrength=(1, 1, 1), exclusive="", direction="Vector", strength= 10, envelope=1, vectorOffset=(0, 0, 0), vectorSpace="Object", offset=0, pointSpace="UV")
    cmds.select('textureDeformerHandle1', r=1)
    #cmds.select('DeformerHandle1', r=1)
...
def Create_alpha_terrain(): #ノイズ
    ...
    cmds.textureDeformer(vectorStrength=(1, 1, 1), exclusive="", direction="Handle", strength=random.uniform(4, 20.0), envelope=1, vectorOffset=(0, 0, 0), vectorSpace="Object", offset=0, pointSpace="UV")
    cmds.select('textureDeformerHandle1', r=1)
